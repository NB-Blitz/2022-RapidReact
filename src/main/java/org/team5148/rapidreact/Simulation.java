...
public class Simulation {
    ...
    private static final Vector3 POSA_R = new Vector3(8.6, 5.4, 270);
    ...
    private static final Vector3 SPEED = new Vector3(0.01, 0.025, 1.7);
    private static final Vector3 DAMP = new Vector3(0.7, 0.7, 0.8);
    private static final double JITTER = 0.3;
    private static final double BATTERY_VOLTAGE = 13;
    ...
    public void drive(Vector3 input) {
        ...
        // Random
        double xSpeed = SPEED.x * (Math.random() * JITTER + 1 - JITTER / 2) * (BATTERY_VOLTAGE / 12);
        double ySpeed = SPEED.y * (Math.random() * JITTER + 1 - JITTER / 2) * (BATTERY_VOLTAGE / 12);
